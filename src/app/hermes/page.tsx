...
import { Cpu, MessageSquare, Terminal, Layers, Target, Plug, Sparkles, History, AudioLines, LayoutDashboard, Mic} from "lucide-react";
...
type HermesTab = "chat" | "talk" | "jarvis" | "studio" | "sessions" | "goals" | "workspace" | "mcps" | "manage" | "control";
...
export default function HermesRoute() {
  ...
  useEffect(() => {
    ...
    const valid: HermesTab[] = ["chat", "talk", "jarvis", "studio", "sessions", "goals", "workspace", "mcps", "manage", "control"];
