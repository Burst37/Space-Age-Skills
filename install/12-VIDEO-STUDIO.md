...
2. The first render downloads the HyperFrames tool automatically — just let it run.
3. In the **Create** sub-tab, follow the on-screen steps to render. Output is a real MP4 saved to your workspace.
