# System prompt — verbatim from `backend/prompts/system_prompt.py`

Source: [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code), `backend/prompts/system_prompt.py`, `SYSTEM_PROMPT` constant. Copied verbatim (unmodified) below — this is the actual text the original app sends as the system message to the coding model.
