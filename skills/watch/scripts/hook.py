...
The first 10 seconds is the highest-leverage analysis window.
Re-runs at 2 fps with word-level Whisper for precise alignment.
"""
...
def analyse_hook(
    ...
    return {"frames": hook_frames, "words": words, "segments": segments, "ran": True}
