...
/// Obtain these values from https://github.com/google-gemini/gemini-cli
const GEMINI_OAUTH_CLIENT_ID: &str = "REDACTED_SEE_GEMINI_CLI_SOURCE";
const GEMINI_OAUTH_CLIENT_SECRET: &str = "REDACTED_SEE_GEMINI_CLI_SOURCE";
